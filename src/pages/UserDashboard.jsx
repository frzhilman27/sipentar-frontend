                          ...
                          <div className="flex-1 pt-1 sm:pt-0">
                            ...
                            <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row justify-between sm:items-center gap-3">
                              ...
                              <button 
                                ...
                                className="inline-flex items-center gap-1.5 w-fit px-3 py-1.5 rounded-lg text-[11px] sm:text-xs font-bold tracking-widest uppercase border bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100 hover:text-slate-800 transition-colors"
                              >
