          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-slate-50 p-8 sm:p-10 rounded-2xl shadow-lg border border-slate-200">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="p-6 bg-white rounded-xl border border-slate-200 text-center shadow-sm">
                    ...
                    <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Terintegrasi</p>
                  </div>
                  <div className="col-span-2 p-8 bg-emerald-800 rounded-xl shadow-md text-left relative overflow-hidden">
                    <h4 className="text-2xl font-bold text-white mb-2 relative z-10">Keterbukaan Informasi</h4>
                    <p className="text-emerald-100 font-medium leading-relaxed relative z-10">Mewujudkan Desa Lamaran Tarung yang aman, bersih, dan sejahtera melalui partisipasi dan pengawasan aktif warga.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-base text-slate-600 leading-relaxed font-medium">
                ...
                <div className="flex items-start gap-4 p-5 bg-slate-50 border border-slate-200 rounded-xl mt-6">
